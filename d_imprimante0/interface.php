      ...
      <div class="row">
        <div class="col-lg-7">
          ...
          <div class="caption header-text">
            ...
            <?php
            $output = shell_exec('ipython data0.py > /dev/null 2>&1 &');
            ?>
          ...
          <pre>
              <?php
                ...
                if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                    ...
                    if ($script === 'print') {
                        $output_print = shell_exec('python print0.py > /dev/null 2>&1 &');
                        $output_print = nl2br($output_print);
                        $output_timer = shell_exec('python timer0.py > /dev/null 2>&1 &');
